...
function deleteProvider(obj){
	$.ajax({
		type:"GET",
		url:path+"/provider/jsp/delprovider.do",
...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/provider/jsp/view.do?&proid="+ obj.attr("proid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/provider/jsp/view.do?method=modify&proid="+ obj.attr("proid");
	});
