...
public interface UserDao {
	 ...
	 * @throws Exception
	 */
	public List<User> getLoginUser(@Param("code")String code)throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<User> getUserList(@Param("userName")String userName,@Param("userRole")Integer roleId,@Param("from")Integer currentPageNo, @Param("pageSize")Integer pageSize)throws Exception;
	/**
	 * 通过条件查询-用户表记录数
	 * @param connection
	 * @param userName
